...
class Mage_Core_Block_Messages extends Mage_Core_Block_Template
{
    ...
    {
        $html = '<' . $this->_messagesFirstLevelTagName . ' id="admin_messages" class="list-unstyled">';
        foreach ($this->getMessages($type) as $message) {
            $html.= '<' . $this->_messagesSecondLevelTagName . ' class="alert alert-'.$message->getType() . '">'
    ...
    {
        $types = array(
            Mage_Core_Model_Message::DANGER,
            Mage_Core_Model_Message::WARNING,
            Mage_Core_Model_Message::INFO,
        ...
        foreach ($types as $type) {
            if ( $messages = $this->getMessages($type) ) {
                ...
                $html .= '<' . $this->_messagesSecondLevelTagName . ' class="alert alert-' . $type . '">';
